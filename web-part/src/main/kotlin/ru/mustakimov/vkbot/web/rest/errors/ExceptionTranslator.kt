package ru.mustakimov.vkbot.web.rest.errors
...
class ExceptionTranslator(private val env: Environment) : ProblemHandling, SecurityAdviceTrait {
    ...
    fun handleEmailAlreadyUsedException(
        ex: ru.mustakimov.vkbot.service.EmailAlreadyUsedException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
    ...
    fun handleUsernameAlreadyUsedException(
        ex: ru.mustakimov.vkbot.service.UsernameAlreadyUsedException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
    ...
    fun handleInvalidPasswordException(
        ex: ru.mustakimov.vkbot.service.InvalidPasswordException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
    ...
    private fun containsPackageName(message: String?) =
        listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "ru.mustakimov.vkbot").any { it == message }
}
